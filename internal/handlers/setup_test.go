...
// Setup test environment configureations
...
// Dummy fucntion to simulate mailing channel
func listenForMail() {
	go func() {
		for {
			_ = <-app.MailChan
...
func getRoutes() http.Handler {
	...
	mux.Get("/search-availability", Repo.Availibility)
	mux.Post("/search-availability", Repo.PostAvailibility)
